...
time lar -n 1 -c wcls_sim_sp.fcl -s ref0/g4.root -o sp-dnn-hydra.root >& log
time lar -n 1 -c wcls-labelling2d.fcl -s sp-dnn-hydra.root --no-output >& labelling2d-dnn-hydra.log
```


```bash
lar -n 1 -c eventdump.fcl -s sp-dnn-hydra.root >& sp-dump-dnn-hydra.log
